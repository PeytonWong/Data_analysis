...
bag = rosbag.Bag(Bag_path.driveway_less_cq)
# fpath = '/home/chendong/data/0712_test_chongqing/excel/down1.xls'
fpath = '/home/dr/down1.xls'
WriteFilePath = '/home/dr/datasheet_cq_can_signal/{0}.xls'.format(
    "driveway_less_cq-" + time.strftime(Bag_path.TimeFormat, Bag_path.TimeLocal))
...
#     data18.append((numpy.random.uniform(speed[i] * 3.6) / 20 + 4) + speed[i])
#     print (numpy.random.uniform(data14[i] * 3.6 / 20) + 4) + data14[i] * 3.6
