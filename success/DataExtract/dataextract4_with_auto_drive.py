...
bag = rosbag.Bag(Bag_path.take_over_longitudinal_brake_pedal)
...
WriteFilePath = '/home/dr/datasheet3/{0}.xls'.format(
    "take_over_longitudinal_brake_pedal-" + time.strftime(Bag_path.TimeFormat, Bag_path.TimeLocal))
